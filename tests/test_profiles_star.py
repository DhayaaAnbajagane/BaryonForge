...
def test_schneider25():
    ...
    X = bfg.Profiles.Schneider25.Stars(**bpar_S25).real(cosmo, R[0], M[0], a); assert isinstance(X, (int, float))
...
def test_arico20():
    ...
    for a in [0.1, 0.5, 1]:
        ...
        bfg.Profiles.Arico20.Stars(**bpar_A20).real(cosmo, R, M, a)
        bfg.Profiles.Arico20.Stars(**bpar_A20).projected(cosmo, R, M, a)
        bfg.Profiles.Arico20.Stars(**bpar_A20).fourier(cosmo, k, M, a)
...
def test_mead20():
    ...
    for a in [0.1, 0.5, 1]:
        ...
        bfg.Profiles.Mead20.Stars(**bpar_M20).real(cosmo, R, M, a)
        bfg.Profiles.Mead20.Stars(**bpar_M20).projected(cosmo, R, M, a)
        bfg.Profiles.Mead20.Stars(**bpar_M20).fourier(cosmo, k, M, a)
