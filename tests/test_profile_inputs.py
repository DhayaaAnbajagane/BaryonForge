...
The cases below cover public profiles and their component profiles.  They use
small mass and radius grids plus reduced integration settings so that this
file checks construction and input handling without full tabulation.
...
CONSTRUCTION_ONLY = {
    "arico20_bound_gas_deprecated",
    "arico20_modified_dark_matter",
    "thermodynamic_green20_nonthermal_fraction",
}
...
def test_profile_constructs_and_accepts_inputs(cosmo, case):
    ...
    if name in CONSTRUCTION_ONLY:
        return
    result = profile.real(cosmo, RADII, MASSES, SCALE_FACTOR)
